...
- [Lunatic (Lx2)](https://github.com/pH-JPEG/jpg-custom-difficulties/blob/main/Main%20Difficulties/Lx2/Lx2.json)
  ...
  - *Latest update:* With the removal of the WIP Stalkers from the game files, MEV is now required to play and host this difficulty.
...
- [Lunatic-Extra (Lx2EX)](https://github.com/pH-JPEG/jpg-custom-difficulties/blob/main/Main%20Difficulties/Lx2EX/Lx2EX.json)
  ...
  - *Latest update:* Now requires MEV. Slashers from Nexuses are white. Exploders from Breeders, Swarmer Eggs, and Swarmer Tunnels are now white. God Shellbacks, God Oppressors, and God Younglings are red.
